...
<div class="page-header">
    <h1>修改商品</h1>
    <h6 id="updateInfo" style="color: red"></h6>
</div>
<form action="" method="">
    ...
    <table class="table table-hover">
        ...
        <tr class="danger">
            <td colspan="2">
                <input type="button" class="btn btn-danger" value="修改商品" onclick="submitForm()" />
            </td>
        </tr>
    </table>
	</form>
    ...
    function submitForm(){
        ...
        $.ajax({
            ...
            success: function(result){
                // 4.1 如果添加成功 -> 跳转到/item/item-list
                if(result.code == 0){
                    location.href = "${pageContext.request.contextPath}/item/item-list";
                }else {
                    // 4.2 如果添加失败 -> 给用户提示.
